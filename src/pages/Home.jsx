    ...
    <div className="space-y-8">
      ...
      <section className="text-center">
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight">
          Dein Personal Trainer im Koffer
        </h1>
        <p className="mt-3 text-slate-600 max-w-2xl mx-auto">
          Workouts ohne Geräte, schnelle Meal-Ideen und smarte Packlisten – optimiert für unterwegs.
        </p>
        <div className="mt-6 flex justify-center gap-3">
          <Link to="/workouts" className="px-5 py-2 rounded-xl bg-slate-900 text-white font-medium">
            Schnell starten
          </Link>
          <Link to="/packlists" className="px-5 py-2 rounded-xl ring-1 ring-slate-300 font-medium bg-white">
            Packliste erstellen
          </Link>
        </div>
      </section>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-white/80">
              Bald: personalisierte Pläne nach Zeit, Ziel & Equipment.
            </p>
          </div>
      ...
      {/* Newsletter-CTA */}
      <section className="rounded-3xl bg-slate-50 p-6 ring-1 ring-slate-200 text-center">
        <h3 className="text-xl font-semibold mb-2">🚀 Bleib auf dem Laufenden</h3>
        <p className="text-slate-600 mb-4">
          Hol dir neue Workouts & Reise-Tipps direkt in dein Postfach.
        </p>
        <form
          onSubmit={(e) => {
            e.preventDefault();
            alert("Danke fürs Eintragen! (später verbinden wir hier Mailchimp o.ä.)");
          }}
