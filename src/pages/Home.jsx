    ...
    <div className='space-y-8'>
      <section className='text-center'>
        ...
        <p className='mt-3 text-slate-600 max-w-2xl mx-auto'>
          Workouts ohne Geräte, schnelle Meal-Ideen und smarte Packlisten –
        ...
        <div className='mt-6 flex justify-center gap-3'>
          ...
          <Link
            to='/packlists'
            className='px-5 py-2 rounded-xl ring-1 ring-slate-300 font-medium bg-white'
          >
            Packliste erstellen
          </Link>
        </div>
      ...
      <section className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
        <Tile
          ...
          title='Workouts'
          emoji='🏋️'
          desc='5/10/20-Minuten-Pläne für Hotel & Outdoor.'
        />
        <Tile
          to='/nutrition'
          title='Ernährung'
          emoji='🍏'
          desc='Snacks & Meal-Prep für Reisen.'
        />
        <Tile
          to='/packlists'
          title='Packlisten'
          emoji='🎒'
          desc='Automatisch generiert – inkl. Fitness-Gear.'
        />
      </section>
      ...
      <section className='rounded-3xl bg-gradient-to-br from-slate-900 to-slate-700 text-white p-6'>
        <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4'>
          ...
          <button className='px-4 py-2 rounded-xl bg-white text-slate-900 font-semibold'>
            In Kürze
          </button>
        </div>
      </section>
